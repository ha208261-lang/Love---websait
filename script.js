...
function handleLogin(event) {
  ...
  if (passwordInput.value.trim() === '7anona') {
    // تسجيل دخول ناجح
...
// يبدأ من: 5/06/2025 الساعة 12:13 صباحاً 
// التاريخ الفعلي في جافاسكريبت: شهر يونيو = 5 (الترتيب الصفرى)
const loveStartDate = new Date(2025, 5, 5, 0, 13, 0);
...
const messageText = `مضيت دروبا ،وعشت أياما احاول فيها أن أصل اليكي حتي جاء اليوم الذي اضع فيه قلبي بين يديك لتكوني بيته الامن❤️`;
